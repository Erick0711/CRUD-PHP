...
<?php require($_SERVER['DOCUMENT_ROOT']."/CRUD-php/App/Data/guardar.php"); ?>
...
<body>
   ...
   <form action="./registro.php" autocomplete="off" method="POST">
                    <h2 class="text-center text-white">Registrar Usuario</h2> 
                    <div class="row mt-4">
                        <div class="col-md-6">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" placeholder="Nivel de equipo" name="nivel_equipo">
                        </div>
                        </div>
